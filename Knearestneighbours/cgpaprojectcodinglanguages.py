...
np.savetxt("cgpaprojectcodinglanguagextest1.csv", X_test, delimiter=",")
np.savetxt("cgpaprojectcodinglanguagextrain1.csv", X_train, delimiter=",")
np.savetxt("cgpaprojectcodinglanguageytrain1.csv", y_train, delimiter=",")
np.savetxt("cgpaprojectcodinglanguageytest1.csv", y_test, delimiter=",")
print(X_test)
