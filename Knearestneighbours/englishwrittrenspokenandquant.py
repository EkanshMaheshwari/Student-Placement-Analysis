...
print(type(X_train))
np.savetxt("englishwrittentestspokenquantxtrain.csv", X_train, delimiter=",")
np.savetxt("englishwrittentestspokenquantxtest.csv", X_test, delimiter=",")
np.savetxt("englishwrittentestspokenquantytrain.csv", y_train, delimiter=",")
np.savetxt("englishwrittentestspokenquantytest.csv", y_test, delimiter=",")
...
for i in range(min(y),max(y)+1):
    ya.append(i)
for i in range(min(ze),max(ze)+1):
    za.append(i)
print(xa)
print(ya)
ax.set_xticks(xa)
