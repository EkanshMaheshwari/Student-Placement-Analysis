...
k=df[["cgpa","numberevents","Number of Publications/Research Paper(If Any):","numbercompany"]]
...
ax.set_xlabel("CGPA")
ax.set_ylabel("Number of Events organised")
ax.set_zlabel("Number of Resarch paper")
