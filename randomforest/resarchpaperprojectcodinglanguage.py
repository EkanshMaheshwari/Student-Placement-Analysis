...
X_train=genfromtxt("papercodingprojectxtrain.csv",delimiter=",")
X_test=genfromtxt("papercodingprojectxtest.csv",delimiter=",")
y_train=genfromtxt("papercodingprojectytrain.csv",delimiter=",")
y_test=genfromtxt("papercodingprojectytest.csv",delimiter=",")
...
ax.set_yticks(ya)
ax.set_zticks(za)
ax.set_xlabel("Number of Resarch Paper")
ax.set_ylabel("Number of Projects")
ax.set_zlabel("Number of Coding language known")
plt.show()