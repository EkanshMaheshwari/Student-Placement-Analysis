...
X_train=genfromtxt("cgpaprojectcodinglanguagextrain1.csv",delimiter=",")
X_test=genfromtxt("cgpaprojectcodinglanguagextest1.csv",delimiter=",")
y_train=genfromtxt("cgpaprojectcodinglanguageytrain1.csv",delimiter=",")
y_test=genfromtxt("cgpaprojectcodinglanguageytest1.csv",delimiter=",")
